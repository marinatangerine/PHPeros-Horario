...
<div class="limiter">
    ...
    <div class="container-register">
        ...
        <div class="half-wrapper">
                <div class="big-icon"><i class="fa fa-file" aria-hidden="true"></i></div>
            </div>
            <div class="half-wrapper">
                <div class="form-body">
                    <form action="{{url('/subjects')}}/{{$result->id_class}}/scheduleexam" method="POST">
                        <span class="register-form-title"><p>Programar examen {{$result->course_start}} - {{$result->course_end}}</p> </span>
            ...
            @if(count($result->items) > 0)
                ...
                @foreach($result->items as $item)
                    ...
                    <a class="icon" href="{{url('/exams')}}/{{$item->id_exam}}/delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    <a class="icon" href="{{url('/exams')}}/{{$item->id_exam}}/marks"><i class="fa fa-institution" aria-hidden="true"></i></a>
                    </td>
                    </tr>
                @endforeach
                </table>
